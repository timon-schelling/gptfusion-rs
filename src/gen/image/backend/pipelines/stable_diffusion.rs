use super::super::models::{unet_2d, vae};
use super::super::schedulers::ddim;
use super::super::schedulers::PredictionType;
use super::super::transformers::clip;
use tch::{nn, Device};
...
pub struct StableDiffusionConfig {
    ...
    pub vae: vae::AutoEncoderKLConfig,
    pub unet: unet_2d::UNet2DConditionModelConfig,
    pub scheduler: ddim::DDIMSchedulerConfig,
}
...
impl StableDiffusionConfig {
    ...
    fn v2_1_(
        ...
        Self { width, height, clip: clip::Config::v2_1(), vae: autoencoder, scheduler, unet }
    }
    ...
    pub fn build_vae(
        ...
        let autoencoder = vae::AutoEncoderKL::new(vs_ae.root(), 3, 3, self.vae.clone());
